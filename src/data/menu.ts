...
export const menuData: MenuCategory[] = [
  ...
  },
  {
    ...
    icon: "",
    items: [
      { id: "hb1", name: "Espresso", description: "Rich and bold single shot", price: 89, category: "hot-brews", isVeg: true, image: "Images/Espresso.jpg" },
      { id: "hb2", name: "Cappuccino", description: "Espresso with steamed milk foam", price: 129, category: "hot-brews", isVeg: true, isBestseller: true , image: "Images/Cappuccino.jpg" },
      { id: "hb3", name: "Latte", description: "Smooth espresso with steamed milk", price: 139, category: "hot-brews", isVeg: true  , image: "Images/Latte.jpg" },
      { id: "hb4", name: "Americano", description: "Espresso with hot water", price: 109, category: "hot-brews", isVeg: true , image: "Images/Americano.jpg" },
      { id: "hb5", name: "Mocha", description: "Chocolate infused coffee", price: 159, category: "hot-brews", isVeg: true, image: "Images/Mocha.jpg" },
      { id: "hb6", name: "Caramel Macchiato", description: "Vanilla latte with caramel drizzle", price: 169, category: "hot-brews", isVeg: true, image: "Images/Caramel Macchiato.jpg" },
    ],
  },
  {
    id: "iced-brews",
    ...
    icon: "",
    items: [
      { id: "ib1", name: "Iced Americano", description: "Chilled espresso with cold water", price: 129, category: "iced-brews", isVeg: true , image: "Images/Iced Americano.jpg" },
      { id: "ib2", name: "Iced Latte", description: "Espresso with cold milk over ice", price: 149, category: "iced-brews", isVeg: true, isBestseller: true , image: "Images/Iced Latte.jpg" },
      { id: "ib3", name: "Iced Mocha", description: "Chocolate coffee served cold", price: 169, category: "iced-brews", isVeg: true , image: "Images/Iced Mocha.jpg" },
      { id: "ib4", name: "Vietnamese Coffee", description: "Strong coffee with condensed milk", price: 159, category: "iced-brews", isVeg: true , image: "Images/Vietnamese Coffee.jpg" },
    ],
  },
  {
    id: "cold-brew",
    ...
    icon: "",
    items: [
      { id: "cb1", name: "Classic Cold Brew", description: "Slow-steeped for 20 hours", price: 159, category: "cold-brew", isVeg: true, image: "Images/Classic Cold Brew.jpg" },
      { id: "cb2", name: "Vanilla Cold Brew", description: "Cold brew with vanilla sweet cream", price: 179, category: "cold-brew", isVeg: true, isBestseller: true , image: "Images/Vanilla Cold Brew.jpg" },
      { id: "cb3", name: "Nitro Cold Brew", description: "Nitrogen-infused cold brew", price: 199, category: "cold-brew", isVeg: true , image: "Images/Nitro Cold Brew.jpg" },
      { id: "cb4", name: "Salted Caramel Cold Brew", description: "With salted caramel cold foam", price: 189, category: "cold-brew", isVeg: true , image: "Images/Salted Caramel Cold Brew.jpg" },
    ],
  },
  {
    id: "frappe",
    ...
    icon: "",
    items: [
      { id: "f1", name: "Classic Coffee Frappe", description: "Blended iced coffee delight", price: 169, category: "frappe", isVeg: true,image: "Images/Classic Coffee Frappe.jpg" },
      { id: "f2", name: "Mocha Frappe", description: "Chocolate coffee blend", price: 189, category: "frappe", isVeg: true, isBestseller: true , image: "Images/Mocha Frappe.jpg" },
      { id: "f3", name: "Caramel Frappe", description: "Caramel swirled coffee blend", price: 189, category: "frappe", isVeg: true  , image: "Images/Caramel Frappe.jpg" },
      { id: "f4", name: "Java Chip Frappe", description: "Coffee with chocolate chips", price: 199, category: "frappe", isVeg: true , image: "Images/Java Chip Frappe.jpg" },
    ],
  },
  {
    id: "milkshakes",
  ...
  },
  {
    ...
    icon: "",
    items: [
      { id: "sm1", name: "Mixed Berry Smoothie", description: "Blend of fresh berries", price: 179, category: "smoothies", isVeg: true, isBestseller: true, image: "Images/Mixed Berry Smoothie.jpg" },
      { id: "sm2", name: "Mango Tango", description: "Tropical mango smoothie", price: 169, category: "smoothies", isVeg: true, image: "Images/Mango Tango.jpg" },
      { id: "sm3", name: "Green Detox", description: "Spinach, apple and ginger", price: 189, category: "smoothies", isVeg: true, image: "Images/Green Detox.jpg" },
      { id: "sm4", name: "Banana Peanut Butter", description: "Protein-rich smoothie", price: 199, category: "smoothies", isVeg: true, image: "Images/Banana Peanut Butter.jpg" },
    ],
  },
  {
    id: "hot-chocolate",
    ...
    icon: "",
    items: [
      { id: "hc1", name: "Classic Hot Chocolate", description: "Rich and creamy cocoa", price: 139, category: "hot-chocolate", isVeg: true, isBestseller: true, image: "Images/Classic  Hot Chocolate.jpg" },
      { id: "hc2", name: "Belgian Hot Chocolate", description: "Premium Belgian cocoa blend", price: 169, category: "hot-chocolate", isVeg: true, image: "Images/Belgian Hot Chocolate.jpg" },
      { id: "hc3", name: "White Hot Chocolate", description: "Creamy white chocolate", price: 159, category: "hot-chocolate", isVeg: true, image: "Images/White Hot Chocolate.jpg" },
      { id: "hc4", name: "Mint Hot Chocolate", description: "With refreshing mint twist", price: 159, category: "hot-chocolate", isVeg: true, image: "Images/Mint Hot Chocolate.jpg" },
    ],
  },
  {
    id: "tea",
    ...
    icon: "",
    items: [
      { id: "te1", name: "English Breakfast", description: "Classic black tea blend", price: 99, category: "tea", isVeg: true, image: "Images/English Breakfast.jpg" },
      { id: "te2", name: "Green Tea", description: "Pure and refreshing", price: 99, category: "tea", isVeg: true,image: "Images/Green Tea.jpg" },
      { id: "te3", name: "Masala Chai", description: "Spiced Indian tea", price: 79, category: "tea", isVeg: true, isBestseller: true, image: "Images/Masala Chai.jpg" },
      { id: "te4", name: "Chamomile Tea", description: "Soothing herbal infusion", price: 109, category: "tea", isVeg: true, image: "Images/Chamomile Tea.jpg" },
      { id: "te5", name: "Iced Peach Tea", description: "Refreshing peach infused tea", price: 129, category: "tea", isVeg: true, image: "Images/Iced Peach Tea.jpg" },
    ],
  },
  {
    id: "mocktails",
  ...
  },
  {
    ...
    icon: "",
    items: [
      { id: "af1", name: "Classic Affogato", description: "Vanilla gelato with espresso shot", price: 179, category: "affogato", isVeg: true, isBestseller: true, image: "Images/Classic Affogato.jpg" },
      { id: "af2", name: "Chocolate Affogato", description: "Chocolate gelato with espresso", price: 199, category: "affogato", isVeg: true, image: "Images/Chocolate Affogato.jpg" },
      { id: "af3", name: "Caramel Affogato", description: "Caramel gelato with coffee", price: 199, category: "affogato", isVeg: true, image: "Images/Caramel Affogato.jpg" },
      { id: "af4", name: "Hazelnut Affogato", description: "Hazelnut gelato drowned in espresso", price: 209, category: "affogato", isVeg: true, image: "Images/Hazelnut Affogato.jpg" },
    ],
  },
];
